...
<%  
    ...
    if(request.getAttribute("actListData")==null) pageContext.setAttribute("actListData",list);
%>
<!DOCTYPE html>
<html>
<head>
...
<title>所有資料 - listAllAct.jsp</title>
...
<nav class="navbar navbar-expand-md navbar-dark bg-success fixed-top justify-content-center">
		 <div align="center"> <h2>所有資料 - listAllAct.jsp</h2>
...
<table id="example" class="display" style="width: 100%">
 ...
 <tbody>
	<c:forEach var="actVO" items="${actListData}" varStatus="s">
		<tr>
            <td>${s.count}</td>
			<td>${actVO.actPicNo}</td>
			<td>${actVO.actNo}</td>
			<td>${actVO.actPicName}</td>		
			<td><img src="<%=request.getContextPath()%>/act/DBGifReader?actPicNo=${actVO.actPicNo}" width="100px"></td>		
			<td>
